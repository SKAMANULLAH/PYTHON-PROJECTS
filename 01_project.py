...
if computer == you_in_form_of_number[you] :
    ...
    if computer == -1  and  you_in_form_of_number[you] ==  1 :
        print("You Have Won The Match")
    elif computer == -1  and  you_in_form_of_number[you] == 0  :
        print("Computer Has Won The Match")
    elif computer == 0  and  you_in_form_of_number[you] == -1  :
        print("You Have Won The Match")
    elif computer ==  0 and  you_in_form_of_number[you] == 1  :
        print("Computer Has Won The Match")
    elif computer == 1  and  you_in_form_of_number[you] == -1  :
        print("Computer Has Won The Match")
    elif computer == 1  and  you_in_form_of_number[you] == 0  :
        print("You Have Won The Match")
